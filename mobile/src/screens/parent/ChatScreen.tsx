...
const styles = StyleSheet.create({
  ...
  mine: { alignSelf: 'flex-end', backgroundColor: '#4F46E5', borderBottomRightRadius: 4 },
  theirs: { alignSelf: 'flex-start', backgroundColor: '#fff', borderBottomLeftRadius: 4, shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 4, elevation: 2 },
  msgText: { fontSize: 15 },
  mineText: { color: '#fff' },
  ...
  sendBtn: { backgroundColor: '#4F46E5', borderRadius: 20, width: 40, height: 40, justifyContent: 'center', alignItems: 'center' },
